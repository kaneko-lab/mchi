...
//----------------------------------------------------------------------------------
      ...
      //TODO - FIX FOLLOWING CODE FOR Jquery >= 1.9
...
//----------------------------------------------------------------------------------
      ...
      //Jung Fixed following code for jQuery > 1.9
      $('body').on('pagebeforeshow.crumbs','div:jqmData(role="page")', function(event, data){
      ...
      // Jung - Fixed for Jquery > 1.9.0
      $('body').on('pagechange.context','div:jqmData(role="panel")', function(){
